 ...
 *
 * @summary X or O button
 * @author Ainsley Pyle
 *
 * Created at     : 2023-10-16 19:30:52 
 * Last modified  : 2023-10-16 19:30:52 
 */
...
public class TicTacToeButton extends JButton {
    ...
    public int btnIDx;
    public int btnIDy; 
    private File fx = new File("C:\\Users\\ainsl\\OneDrive\\Desktop\\JavaBoot\\Lab6\\X.png");
    private File fo = new File("C:\\Users\\ainsl\\OneDrive\\Desktop\\JavaBoot\\Lab6\\O.png");
    TicTacToeButton (TicTacToePanel parent, int x, int y) {
        m_panel = parent;
        btnIDx = x;
        btnIDy = y;
        addActionListener(new TicTacToeButtonListener());
